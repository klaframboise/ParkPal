...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetworkAvailable()) {
            ...
            SharedPreferences prefHistory = getSharedPreferences(getString(R.string.history), Context.MODE_PRIVATE);
            try {
            ...
            cFav.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    addStringFav(etOrigin.getText().toString());
    ...
    public boolean addStringFav(String s) {
        ...
        if(!s.isEmpty()) {
            if (!favs.contains(s)) {
                ...
                err.setText("Favorite already exists");
            }
        }
